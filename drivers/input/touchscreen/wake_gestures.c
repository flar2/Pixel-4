...
/* Flame */
#define SWEEP_Y_MAX_FLAME	2160
#define SWEEP_X_MAX_FLAME	1060
#define SWEEP_EDGE_FLAME	90
#define SWEEP_Y_LIMIT_FLAME	SWEEP_Y_MAX_FLAME-SWEEP_EDGE_FLAME
#define SWEEP_X_LIMIT_FLAME	SWEEP_X_MAX_FLAME-SWEEP_EDGE_FLAME
#define SWEEP_X_B1_FLAME	350
#define SWEEP_X_B2_FLAME	600
#define SWEEP_Y_START_FLAME	800
#define SWEEP_X_START_FLAME	530
#define SWEEP_X_FINAL_FLAME	260
#define SWEEP_Y_NEXT_FLAME	150
...
//get hardware type
static int hw_version = CORAL;
static int __init get_model(char *cmdline_model)
{
	if (strstr(cmdline_model, "flame")) {
		sweep_y_limit = SWEEP_Y_LIMIT_FLAME;
		sweep_x_limit = SWEEP_X_LIMIT_FLAME;
		sweep_x_b1 = SWEEP_X_B1_FLAME;
		sweep_x_b2 = SWEEP_X_B2_FLAME;
		sweep_y_start = SWEEP_Y_START_FLAME;
		sweep_x_start = SWEEP_X_START_FLAME;
		sweep_x_final = SWEEP_X_FINAL_FLAME;
		sweep_y_next = SWEEP_Y_NEXT_FLAME;
		sweep_x_max = SWEEP_X_MAX_FLAME;
		sweep_edge = SWEEP_EDGE_FLAME;
		hw_version = FLAME;
	}
	return 0;
}
